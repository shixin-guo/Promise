...
function loopFiles(item: InternalDataTransferItem, callback: Function) {
...
const traverseFileTree = (
  ...
  callback: {
    (files: File[]): void
    (arg0: (RcFile & { webkitRelativePath?: string | undefined })[]): void
  },
  isAccepted: {
    (_file: RcFile): boolean
    (arg0: RcFile & { webkitRelativePath?: string | undefined }): any
  }
) => {
